...
### v3.1.0 (2026-05-26)
- ✨ **新增代码片段管理器应用** - 强大的代码片段管理工具
  - 支持16种主流编程语言（JavaScript, TypeScript, Python, Java, C++, C#, Go, Rust等）
  - 标签分类系统，支持自定义标签和标签筛选
  - 全文搜索功能，快速定位所需代码
  - 本地存储，数据持久化保存
  - 导入/导出功能，便于分享和备份
...
### v3.0.0 (2026-05-25)
- ✨ **新增随机工具应用** - 实用的随机化工具集
  - 随机数生成器 - 支持自定义范围的随机数生成
  - 密码生成器 - 支持自定义长度和字符类型的强密码生成
  - 掷骰子 - 支持多种面数和多个骰子的投掷
  - 抽奖工具 - 从自定义选项中随机选择
  - 掷硬币 - 简单的硬币正反面随机选择
- 📝 更新应用列表和文档
