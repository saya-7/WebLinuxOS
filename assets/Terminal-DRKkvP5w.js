...
`));k([]),_(e=>[...e,{input:`>>> ${i}`,output:t,isPython:!0}]);return}let h=``;switch(l){case``:break;case`python`:case`python3`:if(C(!0),k([]),!M.current&&!E){_(e=>[...e,{input:i,output:`Python 3.11.3 (Pyodide)
